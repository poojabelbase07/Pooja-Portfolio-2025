...
export default function Footer() {
  return (
    <footer className="my-8">
      <h3 className="text-center text-2xl">Pooja Belbase</h3>
      <ul className="my-4 flex items-center justify-center gap-6 text-[1.6rem]">
        <li className="cursor-pointer transition-transform duration-75 hover:translate-y-[-5px] hover:text-accent-400">
          <Link
            href="www.linkedin.com/in/poojabelbase07"
            target="_blank"
        ...
        <li className="cursor-pointer transition-transform duration-75 hover:translate-y-[-5px] hover:text-accent-400">
          <Link
            href="https://github.com/poojabelbase07"
            aria-label="GitHub"
            target="_blank"
            rel="noreferrer noopener"
          >
        ...
        <li className="cursor-pointer transition-transform duration-75 hover:translate-y-[-5px] hover:text-accent-400">
          <Link
            href="https://leetcode.com/u/pooja___07/"
            aria-label="Leetcode"
            target="_blank"
            rel="noreferrer noopener"
          >
